...
import { ChevronRight, Star, Send, User } from "lucide-react";
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Experience the convenience of having your favorite meals
                delivered right to your doorstep.
              </p>
              <Link
                href="/menu"
                className="bg-orange-500 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-orange-600 inline-flex items-center"
              >
                Order Now
        ...
        <section className="bg-orange-500 py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <form className="max-w-md mx-auto flex">
              ...
              <button
                type="submit"
                className="bg-gray-800 text-white px-6 py-3 rounded-r-full hover:bg-gray-700"
              >
      ...
      <footer className="bg-gray-800 text-white py-10">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4">FoodieExpress</h3>
